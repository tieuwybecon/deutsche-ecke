...
export default function TipsManager() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm('Bạn có chắc chắn muốn xóa bí kíp này?')) return
    ...
    try {
      ...
      alert('Có lỗi xảy ra khi xóa bí kíp')
    }
  }
  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900">Quản lý Bí Kíp</h1>
        <button
          onClick={() => openModal()}
